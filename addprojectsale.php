<?php
    include('indexDB.php');
    session_start();
    $loc=$address=$city=$desc=$am=$ar=$i=$i1=$i2=$i3=$rate='';$cost=0;
    $locErr=$addressErr=$cityErr=$descErr=$amErr=$arErr=$iErr=$costErr=$rateErr='';
...
if($b==true && isset($_POST['submit']))
{
    ...
    $q1="insert into flat(location,".$id.",address,city,description,amenities,area,image,image1,image2,image3) values('$loc',".$_SESSION['id'].",'$address','$city','$desc','$am',$ar,'$i','$i1','$i2','$i3')";
		$result1 = $conn->query($q1);
		echo $q1;
    echo "Insert in flat done";
    $q3="select flat_id from flat where location='$loc' and address='$address' and city='$city' and area=$ar and amenities='$am'";
    $r3=$conn->query($q3);
					...
					<div class="site-navbar">
						...
						<ul class="main-menu">
							...
							?>
							 ...
							 <li><a href="normalHomeSale.php">FOR RENT</a></li>
...
<tr>
<td><b>Barangay or Location:</b></td>
...
<td><input type="text" name="desc" size="50">
...
<tr>
<td><b>Capacity(How many person):</b></td>
...
<tr>
<td><b>Sample Image1:</b></td>
<td><input type="file" name="img1" size="30">
...
<tr>
<td><b>Sample Image2:</b></td>
<td><input type="file" name="img2" size="30">
...
<tr>
<td><b>Sample Image3:</b></td>
<td><input type="file" name="img3" size="30">
<span class="error"></span>
  <br><br>
</td>
</tr>
...
<tr>
<td><b>Sample Image4:</b></td>
<td><input type="file" name="img4" size="30">
<span class="error"></span>
  <br><br>
</td>
</tr>
