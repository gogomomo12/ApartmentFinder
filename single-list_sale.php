...
<body>
				...
				<div class="col-12">
					<div class="site-navbar">
						...
						<?php 
                            ...
                            {
                                echo "<li><a href='builderHome.php'>Back</a></li>";
                            }
                            else
                            {
                                echo "<li><a href='normalHomeSale.php'>Back</a></li>";
                            }
                            ?>
							 <?php 
                            if($_SESSION['type']=='builder')
	...
	<div class="site-breadcrumb">
		<div class="container">
			...
			<span><i class="fa fa-angle-right"></i>Full Details</span>
		</div>
	</div>
  <?php
include('indexDB.php');
...
$b="SELECT name from login where UID=(SELECT bid from flat where flat_id=$x)";
$r4=$conn->query($b);
			...
			<div class="row">
				<div class="col-lg-8 single-list-page">
					<div class="single-list-slider owl-carousel" id="sl-slider">
						<div class="sl-item set-bg" data-setbg="img/img/<?php echo $row['image'] ?>"></div>
						<div class="sl-item set-bg" data-setbg="img/img/<?php echo $row['image1'] ?>"></div>
						<div class="sl-item set-bg" data-setbg="img/img/<?php echo $row['image2'] ?>"></div>
						<div class="sl-item set-bg" data-setbg="img/img/<?php echo $row['image3'] ?>"></div>
          </div>
          <div class="owl-carousel sl-thumb-slider" id="sl-slider-thumb">
						<div class="sl-thumb set-bg" data-setbg="img/img/<?php echo $row['image'] ?>"></div>
						<div class="sl-thumb set-bg" data-setbg="img/img/<?php echo $row['image1'] ?>"></div>
						<div class="sl-thumb set-bg" data-setbg="img/img/<?php echo $row['image2'] ?>"></div>
						<div class="sl-thumb set-bg" data-setbg="img/img/<?php echo $row['image3'] ?>"></div>
					</div>
          <div class="single-list-content">
						<div class="row">
							<div class="col-xl-8 sl-title">
								<h2><i class="fa fa-map-marker"></i><?php echo $row['address'] ?></h2>
								<h2><?php echo $row['location'] ?></h2>
							</div>
							<div class="col-xl-4">
								<a href="payment.php" class="price-btn"><?php echo "PHP ".$row['totalcost']."/-" ?></a>
							</div>
						</div>
						<h3 class="sl-sp-title">Property Details</h3>
						<div class="row property-details-list">
							<div class="col-md-4 col-sm-6">
								<p><i class="fa fa-th-large"></i><?php echo "Capacity:&nbsp;&nbsp;&nbsp;".$row['area']." person" ?></p>
								
                
							</div>
							<div class="col-md-4 col-sm-6">
								<p><i class="fa fa-th-large"></i><?php echo "Rate per Head:&nbsp;&nbsp;&nbsp;".$row['rate']." php"?></p>
						...
						<h3 class="sl-sp-title">Property Features</h3>
						<div class="row property-details-list">
						...
						<div id="accordion" class="plan-accordion">
							<div class="panel">
								<div class="panel-header" id="headingOne">
									<button class="panel-link" data-toggle="collapse" data-target="#collapse3" aria-expanded="flase" aria-controls="collapse3">View floorplan<i class="fa fa-angle-down"></i>
									</button>
								</div>
        ...
        <div class="col-lg-4 col-md-7 sidebar">
					<div class="author-card">
						...
						<div class="author-info">
							<h5><?php echo $r1['nameorg']; ?></h5>
							<p><?php echo "Property Owner"; ?></p>
						</div>
